          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6">
                  <div>
                      ...
                      <input type="email" name="email" id="email" className="bg-gray-50 border-2 border-gray-900 text-gray-900 sm:text-sm rounded-3xl block w-full p-2.5" placeholder="Email"  />
                  </div>
                  ...
                  <Link to='/login' className='text-left underline'>Login</Link>
                    <span className="mx-20"></span>
                  <Link to='/register' className='text-right underline'>Register</Link>
