...
<hr className=' h-0.5 dark:bg-gray-700' /> 
  ...
  <div className="flex flex-col  px-3 pt-2 ">
      <img  className="m-1 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full flex-shrink-0"
         src="https://w7.pngwing.com/pngs/134/447/png-transparent-united-states-pepe-the-frog-anti-defamation-league-hillary-clinton-presidential-campaign-2016-meme-united-states.png" />
           <svg aria-hidden="true" className="w-5  h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Rating star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <p className="ml-3 text-sm font-bold text-gray-900 dark:text-dark">4.95</p></div>
   
  
    <div className="ml-5 p-3 w-full">
  ...
  <div className="col-span-10 col-start-3 mt-4 space-y-4">
    <div className="flex   bg-white border border-gray-200 rounded-lg shadow p-4">
      <div className="flex flex-col  px-3 pt-2 ">
      <img  className="m-1 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full flex-shrink-0"
         src="https://e7.pngegg.com/pngimages/475/527/png-clipart-amphibian-pepe-the-frog-meme-anime-amphibian-face-animals-thumbnail.png" />
           <svg aria-hidden="true" className="w-5  h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Rating star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
              <p className="ml-3 text-sm font-bold text-gray-900 dark:text-dark">4.95</p></div>

      <div className="ml-5 p-2 w-full h-25">
        <div className="flex w-full items-center justify-between">
...
<div className='w-60 m-5  '>
     <input type="text" placeholder='Lägg till kommentar...' name='' id='add-comment'  className=" ml-5 p-2 w-full h-25  " />
 </div>
