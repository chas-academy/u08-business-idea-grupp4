...
<a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-x hover:bg-gray-100 dark:border-white-900 dark:bg-white-800 dark:hover:bg-white-700">
    ...
    <img className="w-full max-w-2xl	max-h-2x1 object-contain" src="https://editorialtelevisa.brightspotcdn.com/dims4/default/bf3664a/2147483647/strip/true/crop/889x500+56+0/resize/1440x810!/quality/90/?url=https%3A%2F%2Fk2-prod-editorial-televisa.s3.amazonaws.com%2Fbrightspot%2Fwp-content%2Fuploads%2F2018%2F04%2F10-Cuentas-de-Instagram-que-debes-seguir-si-eres-amante-de-los-postres.jpeg" alt=""/>
...
<hr className=' h-0.5 dark:bg-gray-700' /> 
  ...
  <div className="flex mt-4  pt-14 ">
    <svg aria-hidden="true" className="w-5  h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Rating star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
    <p className="ml-3 text-sm font-bold text-gray-900 dark:text-dark">4.95</p>
</div>
    <div className="m-1  flex h-14 w-14 items-center justify-center overflow-hidden rounded-full flex-shrink-0">
      <img  src="https://w7.pngwing.com/pngs/134/447/png-transparent-united-states-pepe-the-frog-anti-defamation-league-hillary-clinton-presidential-campaign-2016-meme-united-states.png" />
    </div>
  
    <div className="ml-4 w-full">
      <div className="flex w-full items-center justify-between">
        <h2 className="text-sm font-medium">Maria</h2>
  ...
  <div className="col-span-10 col-start-3 mt-4 space-y-4">
    <div className="flex   bg-white border border-gray-200 rounded-lg shadow p-4">
    <div className="flex mt-4  pt-14 ">
    <svg aria-hidden="true" className="w-5  h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Rating star</title><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
    <p className="ml-3 text-sm font-bold text-gray-900 dark:text-dark">4.95</p>
</div>
      <div className="mx-2 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full flex-shrink-0">
        <img src="https://e7.pngegg.com/pngimages/475/527/png-clipart-amphibian-pepe-the-frog-meme-anime-amphibian-face-animals-thumbnail.png" />
      
      </div>

      <div className="ml-2 w-full">
        <div className="flex w-full items-center justify-between">
          <h2 className="text-sm font-medium">Jasmine</h2>
          <p className="text-sm ">12 hours ago</p>
        </div>
        <div className="mt-4">
          <p className="text-sm">Do you plan to go anywhere later?</p>

          <div className="mt-2 space-x-2">
          <button className="px-3 mt-3 py-1 rounded-xl bg-green-300 text-black font-medium">Reply</button>
          </div>
        </div>
      </div>
    </div> 
...
<div className='w-60 m-5 '>
     <input type="text" placeholder='Lägg till kommentar...' name='' id='add-comment'  className=" h-20  " />
 </div>
...
<div className=' flex flex-row-reverse m-2 px-9 '>
    <div className="relative w-20 h-6 inline-flex self-center">
        ...
        <select className="text-sm text-white font-bold rounded bg-gray-500 border border-grey h-8 w-60 pl-2 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
            <option>⭐0</option>
            <option>⭐1</option>
            <option>⭐1.5</option>
            <option>⭐2</option>
