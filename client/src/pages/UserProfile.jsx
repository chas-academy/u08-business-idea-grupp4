    ...
    return (
        ...
        <div className="grid grid-cols-3 sm:gap-3 gap-1 lg:w-7/12 w-11/12">
            <div className="bg-gray-200 sm:h-48 h-28">
                <Link to="">
                    <img className="h-full w-full" src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1160&q=80" alt="Profile Picture"/>
                </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1497034825429-c343d7c6a68f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1529042410759-befb1204b468?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=772&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1482049016688-2d3e1b311543?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=820&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1065&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1081&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://plus.unsplash.com/premium_photo-1663853560438-6cc3a70a3c97?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80" alt="Profile Picture"/>
            </Link>
            </div>
            <div className="bg-gray-200 sm:h-48 h-28">
            <Link to="">
                <img className="h-full w-full" src="https://ichef.bbci.co.uk/news/976/cpsprodpb/16620/production/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg" alt="Profile Picture"/>
            </Link>
            </div>
        </div>
        </div>
