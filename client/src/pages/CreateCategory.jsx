export default function CreateCategory() {
    return (
        <div className="relative min-h-screen flex flex-col justify-between">
            ...
            <div className="flex justify-center items-center px-4 mr-32 sm:px-6 lg:px-8">
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-3 gap-24 items-center justify-items-center">
                    
                    <div className="w-full sm:w-auto space-between">
                        <div className="border border-gray-300 rounded p-12 sm:p-18 lg:p-24 mb-10 mx-10">
            ...
            <div className="flex justify-center items-center m-12 py-2">
                <button className="w-full sm:w-auto px-24 items-center">
